...
export function Landing() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#09090b] relative overflow-hidden">
      ...
      <nav className="sticky top-0 z-50 border-b border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-[#09090b] backdrop-blur-sm">
      ...
      <main className="relative">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-24">
          <div className="text-center animate-fade-in">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 dark:text-white bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600">
              ...
              <br />
              <span className="animate-text-slide-up inline-block mt-2">
                Organized & Beautiful
              </span>
            </h1>
            <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 sm:leading-8 text-gray-600 dark:text-gray-300 max-w-2xl mx-auto animate-fade-in-up">
              Save, organize, and access your important links in one beautiful
              place. Never lose track of valuable resources again with
              LinkVault's powerful organization tools.
            </p>
        ...
        {/* Features Section */}
        <div className="bg-white/80 dark:bg-[#09090b]/80 backdrop-blur-sm py-16 sm:py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                {[
                  {
                    ...
                    description:
                      "Create custom folders and tags to organize your links exactly how you want.",
                    icon: FolderGit2,
                  },
                  {
                    name: "Instant Search",
                    description:
                      "Find any link in seconds with our powerful search and filtering system.",
                    icon: Search,
                  },
                  {
                    name: "Secure Storage",
                  ...
                  },
                  {
                    name: "AI Powered",
                    description:
                      "Smart suggestions and automatic categorization using AI technology.",
                    icon: Sparkles,
                  },
                ].map((feature, index) => (
                  <div
                    key={feature.name}
                    className="group flex flex-col bg-white/50 dark:bg-[#09090b]/50 p-4 sm:p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 backdrop-blur-sm animate-fade-in"
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8">
              {[
                ...
                <div
                  key={stat.label}
                  className="bg-white/50 dark:bg-[#09090b]/50 backdrop-blur-sm rounded-2xl p-4 sm:p-6 text-center animate-fade-in"
                  style={{ animationDelay: `${index * 100}ms` }}
                >
                  <div className="text-2xl sm:text-3xl font-bold text-blue-600">
                    {stat.value}
                  </div>
                  <div className="mt-1 text-sm sm:text-base text-gray-600 dark:text-gray-300">
                    {stat.label}
                  </div>
                </div>
              ))}
      ...
      {/* Footer */}
      <footer className="relative border-t border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-[#09090b]/80 backdrop-blur-sm py-6 sm:py-8">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
